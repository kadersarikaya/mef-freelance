    ...
    <>
      ...
      <div className="md:px-24 px-8 py-14 md:py-20">
        <div className="flex space-x-6 md:space-x-12 lg:space-x-24 justify-between">
            <AccordionEgitim />
          <div>
            <div className="-mt-20 py-16 px-12 bg-[#E2E7FF80]">
            ...
            <h1 className="text-2xl text-[#2E2E2E] font-bold py-5">MEZUNLARIMIZIN YÜKSEK LİSANSA KABUL EDİLDİĞİ KURUMLAR</h1>
            <div className="flex flex-col space-y-5 text-center">
              <div className="grid grid-cols-2 gap-7">
                <div className="border rounded-lg p-6 bg[#EAEAEA]">
                  <h2 className="text-[#002169] text-2xl text-start">MEF Üniversitesi</h2>
                </div>
                <div className="border rounded-lg p-6 bg[#EAEAEA]">
                  <h2 className="text-[#002169] text-2xl text-start">Çanakkale Onsekiz Mart Üniversitesi</h2>
                </div>
                <div className="border rounded-lg p-6 bg[#EAEAEA]">
                  <h2 className="text-[#002169] text-2xl text-start">Technical University Of Munich
                    Almanya</h2>
                </div>
                <div className="border rounded-lg p-6 bg[#EAEAEA]">
                  <h2 className="text-[#002169] text-2xl text-start">University of Eastern Finland - Finlandiya</h2>
                </div>
                <div className="border rounded-lg p-6 bg[#EAEAEA]">
                  <h2 className="text-[#002169] text-2xl text-start">University of London - İngiltere</h2>
                </div>
                <div className="border rounded-lg p-6 bg[#EAEAEA]">
                  <h2 className="text-[#002169] text-2xl text-start">University Of Victoria - Kanada</h2>
                </div>
              </div>
              <div className="">
                <h1 className="text-start text-2xl text-[#2E2E2E] font-bold py-5">Mezunlarımız Ne Diyor?</h1>
                <div className="grid grid-cols-2 gap-7">
                  <div className="flex flex-col space-y-6">
                    ...
                    <p className="text-[#4D4A47] text-start text-sm font-medium" >
                      <span className="text-[#2D2A26] text-base font-semibold">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</span>
