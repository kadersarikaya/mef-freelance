...
import Lisans from "../(components)/Lisans";
  ...
  return (
    <>
      <div >
        ...
        <div className="relative w-[180px] md:w-[200px] lg:w-[255px] overflow-hidden pt-3">
          <input type="checkbox"
        ...
        <div onClick={() => handleAccordionClick(<Team />)} className="relative w-[180px] md:w-[200px] lg:w-[255px] overflow-hidden">
          <input type="checkbox"
            className="peer absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer"
          />
        ...
        <div onClick={() => handleAccordionClick(<Lisans />)} className="relative w-[180px] md:w-[200px] lg:w-[255px] overflow-hidden">
          <input type="checkbox"
            className="peer absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer"
          />
          <div className="peer-checked:bg-[#002169] text-[#2D2A26] peer-checked:text-white h-12 border-b px-5 py-3 w-full pl-5 flex items-center">
        ...
        <div className="relative w-[180px] md:w-[200px] lg:w-[255px] overflow-hidden">
          <input type="checkbox"
            className="peer absolute top-0 inset-x-0 w-full h-12 opacity-0 z-10 cursor-pointer"
          />
          <div className="peer-checked:bg-[#002169] text-[#2D2A26] peer-checked:text-white h-12 border-b px-5 py-3 w-full pl-5 flex items-center">
